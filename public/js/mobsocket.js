...
class MobSocket {
  constructor (websocketModule) {
    ...
    this.serverOptions = {};
/*
    this.serverOnMessage = this._serverOnMessage.bind(this);
    this.serverOnError = this._serverOnError.bind(this);
  ...
  */
  ...
  closeClient () {
    // TODO need method to disable auto reconnect
    this.clientWS.close();
  }
  ...
  webSocketOnClose (options, ws, evt) {
    ...
    if (options.autoReconnect) {
      ...
      setTimeout(function () { this.createClient(options); }, options.reconnectDelay);
    }
  }
